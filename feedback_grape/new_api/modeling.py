# ruff: noqa
from feedback_grape.utils.operators import create, destroy, identity, sigmap, sigmax, sigmay, sigmaz
...
class Qubit:
    def __init__(self, index, dims):
        self.index = index
        self.dims = dims  # full Hilbert space dims (including qubits and cavities)
...
class HilbertSpace:
    def __init__(self, num_qubits: int, *cavity_dims: int):
        ...
        # Build cavities
        self.cavities = [Cavity(num_qubits + i, cavity_dims[i], dims)
